...
mod tests {
    ...
    test_day!(day08, 6, 6);
    test_day!(day09, 114, 2);
    test_day!(day10, 70, 8);
    test_day!(day11, 374, 8410);
    test_day!(day12, 21, 525152);
    test_day!(day13, 405, 400);
    test_day!(day14, 136, 64);
    test_day!(day15, 1320, 145);
    test_day!(day16, 46, 51);
    test_day!(day17, 102, 94);
    test_day!(day18, 62, 952408144115);
    test_day!(day19, 19114, 167409079868000);
    test_day!(day20, 11687500, 2);
