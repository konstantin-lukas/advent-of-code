...
mod tests {
    ...
    fn day04() {
        let data = utils::load_data(4);
        assert_eq!(solutions::day04::part1(&data), 0);
        assert_eq!(solutions::day04::part2(&data), 0);
    }

    #[test]
    fn day05() {
        let data = utils::load_data(5);
        assert_eq!(solutions::day05::part1(&data), 0);
        assert_eq!(solutions::day05::part2(&data), 0);
    }
